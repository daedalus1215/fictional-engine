package com.food.ordering.system.application.order.service.domain.mapper;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(List<com.food.ordering.system.application.order.service.domain.dto.create.OrderItem> items) {
        return items.stream()
