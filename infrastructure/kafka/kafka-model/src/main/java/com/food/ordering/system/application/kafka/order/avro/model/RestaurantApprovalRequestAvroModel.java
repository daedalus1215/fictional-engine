...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: products = (Product)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
    ...
    private RestaurantOrderStatus restaurantOrderStatus;
    private Product products;
    private Product.Builder productsBuilder;
    private java.math.BigDecimal price;
    private java.time.Instant createdAt;
    ...
    private Builder(RestaurantApprovalRequestAvroModel.Builder other) {
      ...
      if (other.hasProductsBuilder()) {
        this.productsBuilder = Product.newBuilder(other.getProductsBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public RestaurantApprovalRequestAvroModel.Builder setProducts(Product value) {
    ...
    public Product.Builder getProductsBuilder() {
      if (productsBuilder == null) {
        if (hasProducts()) {
          setProductsBuilder(Product.newBuilder(products));
        } else {
          setProductsBuilder(Product.newBuilder());
        }
      }
    ...
    public RestaurantApprovalRequestAvroModel.Builder setProductsBuilder(Product.Builder value) {
      clearProducts();
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        if (productsBuilder != null) {
          ...
          record.products = fieldSetFlags()[5] ? this.products : (Product) defaultValue(fields()[5]);
        }
